...
public class PositionManagerTest {
	...
	public void test_UndoPawnPromotion() throws InvalidPieceException, IllegalNotationException {
		...
		classUnderTest.performMove( Move.valueOf(Move.TYPE_QUEEN_PROMOTION_MASK, Position.e2, Piece.BLACK_PAWN, Position.e1, Piece.NONE, Piece.QUEEN));
		classUnderTest.unperformMove();
		int expectPawn = classUnderTest.getTheBoard().getPieceAtSquare( Position.e2 );
	...
	public void test_BlackPawn_MoveGen_PromoteQueen() throws InvalidPieceException {
		...
		expectedMove = Move.valueOf( Move.TYPE_QUEEN_PROMOTION_MASK, Position.e2, Piece.BLACK_PAWN, Position.e1, Piece.NONE, Piece.QUEEN );
	...
	public void test_BlackPawn_MoveGen_PromoteKnight() throws InvalidPieceException {
		createSutAndRegisterPe("8/8/8/8/8/8/4p3/8 b - - 0 1 ");
		theMl = new MoveList(classUnderTest);
		expectedMove = Move.valueOf( Move.TYPE_PIECE_PROMOTION_MASK, Position.e2, Piece.BLACK_PAWN, Position.e1, Piece.NONE, Piece.KNIGHT );
		assertTrue( theMl.contains( expectedMove ));		
	}
	...
	public void test_BlackPawn_MoveGen_PromoteBishop() throws InvalidPieceException {
		createSutAndRegisterPe("8/8/8/8/8/8/4p3/8 b - - 0 1 ");
		theMl = new MoveList(classUnderTest);
		expectedMove = Move.valueOf( Move.TYPE_PIECE_PROMOTION_MASK, Position.e2, Piece.BLACK_PAWN, Position.e1, Piece.NONE, Piece.BISHOP );
		assertTrue( theMl.contains( expectedMove ));		
	}
	...
	public void test_BlackPawn_MoveGen_PromoteRook() throws InvalidPieceException {
		createSutAndRegisterPe("8/8/8/8/8/8/4p3/8 b - - 0 1 ");
		theMl = new MoveList(classUnderTest);
		expectedMove = Move.valueOf( Move.TYPE_PIECE_PROMOTION_MASK, Position.e2, Piece.BLACK_PAWN, Position.e1, Piece.NONE, Piece.ROOK );
		assertTrue( theMl.contains( expectedMove ));
	}
	...
	public void test_WhitePawn_MoveGen_PromoteQueen() throws InvalidPieceException {
		...
		theMl = new MoveList(classUnderTest);
		expectedMove = Move.valueOf( Move.TYPE_QUEEN_PROMOTION_MASK, Position.e7, Piece.PAWN, Position.e8, Piece.NONE, Piece.QUEEN );
		assertTrue( theMl.contains( expectedMove ));
	}	
	...
	public void test_WhitePawn_MoveGen_PromoteKnight() throws InvalidPieceException {
		createSutAndRegisterPe("8/4P3/8/8/8/8/8/8 w - - 0 1 ");
		theMl = new MoveList(classUnderTest);
		expectedMove = Move.valueOf( Move.TYPE_PIECE_PROMOTION_MASK, Position.e7, Piece.PAWN, Position.e8, Piece.NONE, Piece.KNIGHT );
		assertTrue( theMl.contains( expectedMove ));		
	}
	...
	public void test_WhitePawn_MoveGen_PromoteBishop() throws InvalidPieceException {
		createSutAndRegisterPe("8/4P3/8/8/8/8/8/8 w - - 0 1 ");
		theMl = new MoveList(classUnderTest);
		expectedMove = Move.valueOf( Move.TYPE_PIECE_PROMOTION_MASK, Position.e7, Piece.PAWN, Position.e8, Piece.NONE, Piece.BISHOP );
		assertTrue( theMl.contains( expectedMove ));			
	}
	...
	public void test_WhitePawn_MoveGen_PromoteRook() throws InvalidPieceException {
		createSutAndRegisterPe("8/4P3/8/8/8/8/8/8 w - - 0 1 ");
		theMl = new MoveList(classUnderTest);
		expectedMove = Move.valueOf( Move.TYPE_PIECE_PROMOTION_MASK, Position.e7, Piece.PAWN, Position.e8, Piece.NONE, Piece.ROOK );
		assertTrue( theMl.contains( expectedMove ));	
	}
