...
public class ZobristHashCodeTest {
	...
	public void test_EndGameJustPromotionMove_RegenerateSamePosition() throws Exception {
		...
		pm.performMove(Move.toMove(new GenericMove("a2a1Q"), pm.getTheBoard(), Move.TYPE_QUEEN_PROMOTION_MASK));
	...
	public void test_EndGameJustPromotion_RegenerateSamePosition() throws Exception {
		...
		pm.performMove(Move.valueOf(Move.TYPE_QUEEN_PROMOTION_MASK, Position.a2, Piece.BLACK_PAWN, Position.a1, Piece.NONE, Piece.QUEEN));
		pm.unperformMove();
